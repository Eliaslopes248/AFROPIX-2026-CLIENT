...
const INTERESTS = [
  { id: 'SPORTS_AND_FITNESS', title: 'Sports & Fitness', subtitle: 'Find local teams and gyms', icon: 'fitness_center', iconBg: 'bg-blue-100 dark:bg-blue-900/30', iconColor: 'text-blue-500'},
  { id: 'ARTS_AND_CULTURE', title: 'Arts & Culture', subtitle: 'Galleries and studios', icon: 'palette', iconBg: 'bg-purple-100 dark:bg-purple-900/30', iconColor: 'text-purple-500'},
  { id: 'TECH_AND_CODING', title: 'Tech & Coding', subtitle: 'Hackathons and meetups', icon: 'terminal', iconBg: 'bg-emerald-100 dark:bg-emerald-900/30', iconColor: 'text-emerald-500'},
  { id: 'MUSIC_AND_PERFORMANCE', title: 'Music & Performance', subtitle: 'Live shows and jam sessions', icon: 'music_note', iconBg: 'bg-pink-100 dark:bg-pink-900/30', iconColor: 'text-pink-500'},
  { id: 'FOOD_AND_DRINK', title: 'Food & Drink', subtitle: 'Cafes, bars, and markets', icon: 'restaurant', iconBg: 'bg-orange-100 dark:bg-orange-900/30', iconColor: 'text-orange-500'},
  { id: 'NATURE_AND_OUTDOORS', title: 'Nature & Outdoors', subtitle: 'Hiking and gardening', icon: 'forest', iconBg: 'bg-green-100 dark:bg-green-900/30', iconColor: 'text-green-500'},
